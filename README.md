...
- **Ask agent about a selection** — right-click selected terminal or editor text. The shell's own stream stays on screen; there is no command bar above the pane.
